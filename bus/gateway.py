...
Env:  NEO4J_URI (shared graph), RESCUEGRID_BUS (:8096), RESCUEGRID_QA (:8095), RESCUEGRID_NETSIM (:5000),
      RESCUEGRID_VISION_FRAMES (/home/hp2/Aditya/vision/frames), RESCUEGRID_TWIN_DIST (dist-live), RESCUEGRID_SCENARIO
"""
...
KENIL = os.environ.get("RESCUEGRID_REASONING", "/home/hp2/kenil/rescuegrid-reasoning")
...
VISION_FRAMES = os.environ.get("RESCUEGRID_VISION_FRAMES", "/home/hp2/Aditya/vision/frames")
SAMPLES = os.path.join(ROOT, "vision", "samples")
DIST = os.environ.get("RESCUEGRID_TWIN_DIST", os.path.join(os.path.dirname(ROOT), "mockfrontend", "edgeAI", "frontend", "dist-live"))
