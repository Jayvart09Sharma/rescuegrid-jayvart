...
function Effects() {
  ...
  return (
    <EffectComposer multisampling={0}>
      <Bloom mipmapBlur intensity={1.35} luminanceThreshold={0.24} luminanceSmoothing={0.3} radius={0.75} />
...
export function Scene() {
  return (
    ...
    >
      ...
      <OrbitControls makeDefault enableDamping dampingFactor={0.08} maxPolarAngle={Math.PI * 0.46} minDistance={12} maxDistance={220} autoRotateSpeed={0.35} />
      <CameraRig />
      <Shaker>
        <ParticleCity />
        <Overlays />
